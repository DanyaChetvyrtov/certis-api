...
class BudgetPlanningSchemaTest : AbstractIntegrationTest() {
    ...
    @Test
    fun `should persist an auditable mckp result with editable coverage bounded by one`() {
        val user = userFixture.createInDb()
        val now = OffsetDateTime.now()
        ...
        assertOutOfRangeCoverageRejected(categoryConstraintId, user.id)
        val selectedFundingLevelId = insertFundingLevelsWithEditedCoverage(categoryConstraintId, user.id)
    ...
    private fun assertOutOfRangeCoverageRejected(
    ...
    private fun insertFundingLevelsWithEditedCoverage(
        categoryConstraintId: UUID,
        userId: UUID,
    ): UUID {
        insertFundingLevel(
    ...
    private fun insertConstraints(
        ...
        dsl.insertInto(Tables.BUDGET_CONSTRAINT_REVISIONS)
            ...
            .set(Tables.BUDGET_CONSTRAINT_REVISIONS.SAVINGS_FLOOR_AMOUNT, BigDecimal("30500.00"))
            .set(Tables.BUDGET_CONSTRAINT_REVISIONS.REQUIRED_AMOUNT, BigDecimal("82000.00"))
    ...
    private fun insertCategoryConstraint(
        ...
        dsl.insertInto(Tables.BUDGET_CATEGORY_CONSTRAINTS)
            ...
            .set(Tables.BUDGET_CATEGORY_CONSTRAINTS.REQUIRED_AMOUNT, BigDecimal("15000.00"))
    ...
    private fun insertOptimizationRun(
        ...
        dsl.insertInto(Tables.BUDGET_OPTIMIZATION_RUNS)
            ...
            .set(Tables.BUDGET_OPTIMIZATION_RUNS.REQUIRED_AMOUNT, BigDecimal("82000.00"))
    ...
    private fun insertOptimizationDecision(
        ...
        dsl.insertInto(Tables.BUDGET_OPTIMIZATION_DECISIONS)
            ...
            .set(Tables.BUDGET_OPTIMIZATION_DECISIONS.REQUIRED_AMOUNT, BigDecimal("15000.00"))
