...
import ru.digitalhustle.certis.features.account.spi.RecurringTransactionAccountUsage
...
class AccountAggregatorImplTest {
    ...
    private val recurringTransactionUsage = mock(RecurringTransactionAccountUsage::class.java)
    ...
    fun `should reject closing account used by recurring transaction`() {
        ...
        assertThatThrownBy {
            ...
            .hasMessage(AccountErrorMessages.ACCOUNT_IN_USE)
