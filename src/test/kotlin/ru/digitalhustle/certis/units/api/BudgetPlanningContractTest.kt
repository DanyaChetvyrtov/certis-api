...
class BudgetPlanningContractTest {
    ...
    fun `should expose planning session endpoint contract`() {
        ...
        assertBasePath(BudgetPlanCancellationController::class)
        assertPut(
            BudgetPlanCancellationController::class,
            "cancelPlan",
    ...
    fun `should expose optimization endpoint contract`() {
        ...
        assertBasePath(BudgetPlanningApplicationController::class)
        assertPut(
            BudgetPlanningApplicationController::class,
            "applyOptimization",
