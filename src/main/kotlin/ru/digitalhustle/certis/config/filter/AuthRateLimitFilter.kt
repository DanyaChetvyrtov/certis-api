package ru.digitalhustle.certis.config.filter
...
class AuthRateLimitFilter(
    ...
    companion object {
        ...
        private const val RATE_LIMIT_HEADER = "X-RateLimit-Limit"
    ...
    override fun doFilterInternal(
        ...
        response.setHeader(RATE_LIMIT_HEADER, namedRule.rule.capacity.toString())
        ...
        if (!probe.isConsumed) {
            ...
            objectMapper.writeValue(
                ...
                exceptionResponseProvider.createResponse(
                    ...
                    message = SecurityErrorMessages.TOO_MANY_REQUESTS,
                ),
            )
            return
        }
