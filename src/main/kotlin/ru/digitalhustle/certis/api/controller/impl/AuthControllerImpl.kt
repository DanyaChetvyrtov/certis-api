...
import ru.digitalhustle.certis.api.controller.AuthController
...
import ru.digitalhustle.certis.api.mapper.AuthSessionMapper
import ru.digitalhustle.certis.api.mapper.UserMapper
...
class AuthControllerImpl(
    ...
    override fun getSessions(jwtDetails: JwtDetails): SessionsRs {
        val sessions = authQueryService.getSessions(jwtDetails.id).map(authSessionMapper::convert)
