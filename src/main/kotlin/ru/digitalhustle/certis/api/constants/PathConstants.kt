...
object PathConstants {
    ...
    const val BUDGET_PLAN_CANCEL = "$BUDGET_PLAN_ID/cancel"
    ...
    const val BUDGET_PLAN_OPTIMIZATION_DISMISS = "$BUDGET_PLAN_OPTIMIZATION_ID/dismiss"
    const val BUDGET_PLAN_OPTIMIZATION_APPLY = "$BUDGET_PLAN_OPTIMIZATION_ID/apply"
